...
$sql = <<<SQL
    SELECT id , Username, Telephone1 ,   surname , name,smsid , remarks , status , message , timeSent
    FROM `smsmessages` WHERE Username = '$Username'
SQL;
...
th.dt-center, td.dt-center { text-align: center; }
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
             var table = $('#standalone').DataTable({
             responsive: true,
             dom: 'Bfrtip',
				buttons: ['print' ,
					{
						...
						pageSize: 'A4', 
				   		title:'Απεσταλμένα SMS σε ανεξάρτητους χρήστες'					
                           }
				],
...
<br> 
 <h3>
     Αρχείο αποστολής SMS του χρήστη <?php echo $_SESSION['Username'] ?>
 </h3>
...
echo "<table id='standalone' class='table table-striped table-bordered' width='100%' cellspacing='0'>
<thead>
<tr>
    <th>id</th>
    <th>Χρήστης</th>
